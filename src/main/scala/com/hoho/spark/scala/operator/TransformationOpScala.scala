...
object TransformationOpScala {
  ...
  def distinctOp(sc: SparkContext): Unit = {
    val dataRDD = sc.parallelize(Array[(Int, String)]((150001, "US"), (150002, "CN"), (150003, "CN"), (150004, "IN")))
    //由于是统计开播的大区信息，需要根据大区信息去重，所以只保留大区信息
    dataRDD.map(_._2).distinct().foreach(println(_))
  }

  def joinOp(sc: SparkContext): Unit = {
    val dataRDD1 = sc.parallelize(Array[(Int, String)]((150001, "US"), (150002, "CN"), (150003, "CN"), (150004, "IN")))
    val dataRDD2 = sc.parallelize(Array[(Int, Int)]((150001, 400), (150002, 200), (150003, 300), (150004, 100)))
  ...
  def sortByKeyOp(sc: SparkContext): Unit = {
    val dataRDD = sc.parallelize(Array[(Int, Int)]((150001, 400), (150002, 200), (150003, 300), (150004, 100)))
  ...
  def groupByKeyOp2(sc: SparkContext): Unit = {
    val dataRDD = sc.parallelize(Array[(Int, String,String)]((150001, "US", "male"), (150002, "CN", "female"), (150003, "CN", "male"), (150004, "IN", "female")))
  ...
  def flatMapOp(sc: SparkContext): Unit = {
    val dataRDD = sc.parallelize(Array[String]("good good study", "day day up"))
