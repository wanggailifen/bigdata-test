...
public class HBaseDDL {
    ...
    private static final Logger log = LoggerFactory.getLogger(HBaseDDL.class);
...
//        try {
//            createNamespace("hoho");
//        } catch (IOException e) {
//            log.warn("创建命名空间异常", e);
//        }

        boolean tableExists = isTableExists("hoho", "student");
